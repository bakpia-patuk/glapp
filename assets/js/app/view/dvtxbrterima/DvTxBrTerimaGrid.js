...
//                                filterCollection = [],
//                                combo = this.up('grid').down('#divisiBmDivFilter').getValue(),
//                                combo2 = this.up('grid').down('#dateBmDivFilter2').getValue();;
//
...
//                                filterCollection = [],
//                                combo = this.up('grid').down('#divisiBmDivFilter').getValue(),
//                                combo2 = this.up('grid').down('#dateBmDivFilter').getValue();
//
//                            if(combo2 !== null) {
//                                var statusFilter = new Ext.util.Filter({
//                                    property: 'tgl_trx',
...
//                        console.log(this.down('#divbarangmasukdetailgrid'));
//                    }
                }
            ],
//            features: [
