...
//                                filterCollection = [],
//                                combo = this.up('grid').down('#divisiMbInvFilter').getValue(),
//                                combo2 = this.up('grid').down('#dateMbInvFilter2').getValue();;
//
...
//                                filterCollection = [],
//                                combo = this.up('grid').down('#divisiMbInvFilter').getValue(),
//                                combo2 = this.up('grid').down('#dateMbInvFilter').getValue();
//
//                            if(combo2 !== null) {
//                                var statusFilter = new Ext.util.Filter({
//                                    property: 'tgl_trx',
