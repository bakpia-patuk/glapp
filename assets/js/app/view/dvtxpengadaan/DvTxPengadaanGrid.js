            ...
            columns: [
                {
                    ...
                    renderer: function(value, meta, record) {
                        var status = record.get('pengStatus'),
                                ...
                                statusPo = record.get('poStatus');
                        if (status == 1 && statusDiv == 1 && statusPo == 1) {
                            return '<span style="color:#be03c1;">' + value + '</span>';
                        } else if (status == 0 && statusDiv == 1 && statusPo == 0) {
                            return '<span style="color:#0000FF;">' + value + '</span>';
                        } else if (status == 1 && statusDiv == 1 && statusPo == 0) {
                            return '<span style="color:#ce7f00;">' + value + '</span>';
                        } else if (status == 1 && statusDiv == 1 && statusPo == 2) {
                            return '<span style="color:#48ff00;">' + value + '</span>';
                        } else if (status == 0 && statusDiv == 0 && statusPo == 0) {
