 ...
 * @author Isht Ae
 **/
Ext.define('GlApp.view.ivtxbrkeluar.IvTxBrKeluarGrid', {
    extend: 'Ext.grid.Panel',
    alias: 'widget.ivtxbrkeluar.ivtxbrkeluargrid',
    itemId: 'ivtxbrkeluargrid',
    autoScroll: true,
    forceFit: true,
//    store: 'PenginvStore',
    columnLines: true,
...
//                                filterCollection = [],
//                                combo = this.up('grid').down('#divisiBkInvFilter').getValue(),
//                                combo2 = this.up('grid').down('#dateBkInvFilter2').getValue();;
//
...
//                                filterCollection = [],
//                                combo = this.up('grid').down('#divisiBkInvFilter').getValue(),
//                                combo2 = this.up('grid').down('#dateBkInvFilter').getValue();
//
//                            if(combo2 !== null) {
//                                var statusFilter = new Ext.util.Filter({
//                                    property: 'tgl_trx',
