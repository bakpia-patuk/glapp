 ...
 * @author Coepoe
 */
class Bkmasuk_model extends MY_Model {
...
//                    $keterangan = $this->get_detail('id', $row->kas_dtlkeperluan, 'ms_keperluan_akun')->kd_name;
//                } else {
//                    $keterangan = $this->get_detail('id', $row->kas_dtlkeperluan, 'list_akun')->akun_name;
//                }
    ...
    function bank_process() {
        ...
        $keterangan_string = 'Bank masuk dari ';
