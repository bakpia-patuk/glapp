 ...
 */
$config['site_title']                 = "GL Apps";       // Site Title, example.com
$config['admin_email']                = "appcerdas@yahoo.com"; // Admin Email, admin@example.com
$config['default_group']              = 'umum';           // Default group, use name
